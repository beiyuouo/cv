...
% \photo{profile.png}
\name{Bingjie}{YAN} % (闫冰洁)
\position{Trustworthy Federated Learning{\enskip\cdotp\enskip}Biomedical Foundation Model{\enskip\cdotp\enskip}Edge AI in Healthcare{\enskip\cdotp\enskip}Privacy-Preserving ML}
