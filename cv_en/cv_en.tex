...
% \photo{profile.png}
\name{Bingjie}{YAN} % (闫冰洁)
\position{Federated Foundation Model{\enskip\cdotp\enskip}Trustworthy Federated Learning{\enskip\cdotp\enskip}Distributed Optimization{\enskip\cdotp\enskip}AI in Healthcare}
