...
{2024.03 - PRESENT} % Date(s)
{
    \begin{cvitems}
        ...
        \item {\textbf{Missing Modality Imputation in MMFL.} We propose a novel missing modality imputation method in multimodal federated foundation model to handle the missing modality data in the federated learning scenarios.}
\end{cvitems}
}
