...
{Federated Collaborative Platform and System for Digital Ophthalmology} % Organization
{Beijing, China} % Location
{2021.12 - 2023.06} % Date(s)
{
    \begin{cvitems}
        \item {Designed the architecture and core components of the federated learning platform for ophthalmology applications.}
        \item {Implemented state-of-the-art asynchronous federated learning algorithms to enable efficient and robust model training across distributed hospitals.}
        \item {Explored multi-modal AI solutions (fundus image, OCT image, medical report, etc.) to build a robust model with cross-silo modal heterogeneous data in ophthalmic diagnosis.}
    \end{cvitems}
}
