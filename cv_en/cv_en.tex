...
% \photo{profile.png}
\name{Bingjie}{YAN} % (闫冰洁)
\position{Trustworthy Federated Learning{\enskip\cdotp\enskip}Privacy-Preserving ML{\enskip\cdotp\enskip}AI for Healthcare{\enskip\cdotp\enskip}Multi-modal Learning}
