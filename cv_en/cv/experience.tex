...
\cventry
{Core Member. Research Subject with Aier EYE Hospital (China's largest eye service provider)} % Job titl
...
{Summer Workshop on Trustworthy Federated Learning} % Organization
{Beijing, China} % Location
...
\cventry
{Host. Undergraduate Student Innovation and Entrepreneurship Practice Project (Host)} % Job title
